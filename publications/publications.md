...
<li class='list-group-item'>Kohinoor M. Darda and <strong>Richard Ramsey</strong>. (in press) "The promise and pitfalls of studying the neurophysiological correlates of automatic imitation." <em>A chapter in the book "Automatic Imitation" edited by O. Genschow & E. Cracco</em><br><a class="btn btn-outline-dark btn-sm", href="https://osf.io/preprints/psyarxiv/yfxdn" target="_blank" rel="noopener noreferrer">
        <i class="bi bi-file-earmark-pdf" role='img' aria-label='Preprint'></i>
        Preprint
    </a></li>
