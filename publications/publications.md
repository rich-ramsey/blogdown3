...
<li class='list-group-item'>Eliane Deschrijver and <strong>Richard Ramsey</strong>. (2024) "Discrimination occurs in the absence of group division and identity."<br><a class="btn btn-outline-dark btn-sm", href="https://osf.io/preprints/psyarxiv/xv38p" target="_blank" rel="noopener noreferrer">
        <i class="bi bi-file-earmark-pdf" role='img' aria-label='Preprint'></i>
        Preprint
