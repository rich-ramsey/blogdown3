...
```{r, echo=FALSE, fig.cap="adapted from Krushke & Liddel (2018)", fig.align='left', out.width="100%", out.height="100%"}
...
Note: depending on your research question and type of data, the relative merits and value of parameter estimation versus model comparison may differ. For example, in my experience in exp psych / cog neuro, model comparison has not been as helpful, but that's just our experience. I am not in anyway suggesting that model comparison is not in general helpful or appropriate. It is just that we tend to use factorial designs and we are more familiar with interpreting parameters. However, in principle they are both valuable and serve different purposes, so they may work for other labs, questions, datasets more than others.
...
2.  Sophisticated and complex model building enabled via STAN
3.  brms uses lme4 syntax, which will be familiar to many psych people
