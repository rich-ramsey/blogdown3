...
```{r, echo=FALSE, fig.cap="Adapted from Krushke & Liddel (2018). BF = Bayes factor; MLE = Maximum likelihood estimate; CI = confidence interval; HDI = highest density interval.", fig.align='left', out.width="100%", out.height="100%"}
...
There is one major consequence of letting go of p values and other categorical ways of thinking about inferences. There are no bright lines for inference. There are no clear-cut and categorical decision points or inferential cliffs to fall off of as the *p* value approaches magical values, such as 0.05. And there are no pre-set benchmarks for determining how "evidential" a Bayes factor is, in terms of saying some thing like "anecodotal, moderate, strong, very strong, or extreme". And these are all good things to avoid (Funder & Ozer, [2019](https://journals.sagepub.com/doi/abs/10.1177/2515245919847202); McElthreath, [2023](https://elevanth.org/blog/2023/07/17/none-of-the-above/)), as they have led to ritualistic and frequently thoughtless statistical inferences (Gigerenzer, [2018](https://journals.sagepub.com/doi/full/10.1177/2515245918771329)). Instead, dare I even say it as a professional scientist who wants keep at least a modicum of self-respect, you ultimately need to use *evaluative* language to consider what your results mean when situated within the relevant context. Lordy, lordy. Whatever next? 
