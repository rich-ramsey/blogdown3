...
The latest version using Quarto and the quarto-preprint extension:

<https://github.com/rich-ramsey/reproducible_workflow_quarto>

An older version using R markdown and the papaja() package:
...
## Using ETH's High Performance Computing cluster (Euler) to fit Bayesian regression models

This project summarises our lab's current workflow using the ETH Zurich high performance computing cluster - Euler - to fit Bayesian regression models. 

Sven Panis wrote this tutorial.

<https://github.com/rich-ramsey/euler_lab_manual>